  ...
  return (
    <div className="relative w-full h-80 bg-gradient-to-t from-blue-900 via-blue-900 to-blue-400">
      ...
      <div className="container mx-auto flex flex-col justify-end items-end h-full">
        {/* <svg xmlns="http://www.w3.org/2000/svg" className="absolute -left-12 top-7 md:left-56 md:top-36 transform md:-translate-y-1/2 md:hidden" width="150" height="150" viewBox="0 0 180.969 180.969">
