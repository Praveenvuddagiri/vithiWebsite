    ...
    <div className='relative bg-[#0b163b] h-fit flex justify-center pt-10'>
      ...
      <div className='w-[90%] flex flex-col gap-7'>
        <div className='text-white text-center'>
            ...
            <p className='font-semibold px-10'>Vithi has an excellent track record of Managing, Designing, Implementing & Deploying numerous projects which are mission critical to our customers focused mainly on on-time delivery with quality driven by SMEs across technologies.</p>
        </div>
        <div className='text-white  '>
            <ul className=' border-spacing-5 grid grid-rows-3 grid-cols-1 md:grid-cols-2 gap-6 p-8'>
                {
                    Keydifference.map((userData)=>{
                        return (
