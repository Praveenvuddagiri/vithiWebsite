  ...
  return (
    <>
      ...
      <div className="flex justify-between flex-col md:flex-row items-center">
        ...
        <ContentBox header={data[0].headLine} para={data[0].ParaGraph} link={data[0].link} />
      </div>
      ...
      <div className="flex justify-between flex-col-reverse md:flex-row-reverse items-center mt-20">
        ...
        <ContentBox header={data[1].headLine} para={data[1].ParaGraph} link={data[1].link} />
      </div>
      ...
      <div className="flex flex-col md:flex-row items-center mt-10 md:mt-0">
        ...
        <ContentBox header={data[2].headLine} para={data[2].ParaGraph} link={data[2].link} />
      </div>
      ...
      <div className="flex flex-col-reverse md:flex-row-reverse items-center mb-20">
        ...
        <ContentBox header={data[3].headLine} para={data[3].ParaGraph} link={data[3].link} />
      </div>
      ...
      <CombinedComponent
        ...
        link={data[3].link}
        image1={data[3].imageUrls.image1}
        image2={data[3].imageUrls.image2}
        right={true}
      />
